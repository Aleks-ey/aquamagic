          ...
          <tbody className="bg-white divide-y divide-gray-500">
            ...
            <tr>
              ...
              <td className="px-6 py-4">
                <input
                  type="text"
                  list="add-location-options"
                  value={location}
                  onChange={(e) => setLocation(e.target.value)}
                  className="mt-1 block w-full py-2 px-3 border border-black bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                />
                <datalist id="add-location-options">
                  <option value="Rangeview" />
                  <option value="Gateway" />
                  <option value="Central Aurora High School" />
                  <option value="Hinkley High School" />
                </datalist>
              </td>
            </tr>
            {category === "schedule" && (
              <tr>
                ...
                <td className="px-6 py-4">
                  <input
                    type="text"
                    list="add-coach-options"
                    value={coach}
                    onChange={(e) => setCoach(e.target.value)}
                    className="mt-1 block w-full py-2 px-3 border border-black bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                  />
                  <datalist id="add-coach-options">
