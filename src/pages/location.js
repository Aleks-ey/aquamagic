    ...
    return (
        <div className="flex flex-col md:flex-row pt-4 mt-20 md:mt-24 mb-40 bg-white md:bg-gradient-to-b from-pool-water to-white min-h-screen justify-center">
            <iframe 
                ...
                className="maps rounded-md">
            </iframe>

            <div className="h-auto w-0.1 bg-gray-400 ml-12"></div>

            <div className="flex flex-col md:w-1/3">
                <div className="flex flex-col md:hidden w-full h-full p-4 md:ml-12 justify-center bg-gradient-to-b md:bg-gradient-to-br from-pool-water to-white rounded-md">
