...
const Location = () => {
  ...
  return (
    <div className="flex flex-col pt-4 mt-20 mb-20 bg-white justify-center">
      {/* --------------------------- AURORA INSTRUCTIONS --------------------------- */}
      <h1 className="text-4xl lg:text-5xl text-center font-serif my-8">
        Aurora Central High School
      </h1>
      <div className="flex flex-col md:flex-row justify-center min-h-[400px]">
        <iframe
        ...
        {/* <div className="h-auto w-0.1 bg-gray-400 ml-12"></div>
                ...
                <div className="flex flex-col md:w-1/3">
                    <div className="flex flex-col w-full h-full p-4 md:ml-6 justify-center md:rounded-md">
                        <h2 className="text-2xl text-center font-serif"> Aurora Central Instructions:</h2>
                        ...
                        <Image src="/aurora_birdseye.png" alt="google maps birdseye view of aurora central high school" width={400} height={400} className="flex w-full pt-4 rounded-md"/>
                    </div>
                </div> */}
      </div>
      {/* Separator line */}
      <div className="w-auto h-0.5 bg-gray-400 mt-12 mx-6"></div>
      {/* --------------------------- HINKLEY INSTRUCTIONS --------------------------- */}
      <h1 className="text-4xl lg:text-5xl text-center font-serif my-8">
        Hinkley High School
      </h1>
      <div className="flex flex-col-reverse md:flex-row justify-center min-h-[400px]">
        {/* <div className="flex flex-col md:w-1/3">
                    <div className="flex flex-col w-full h-full p-4 md:mr-6 justify-center md:rounded-md">
                        <h2 className="text-2xl text-center font-serif"> Hinkley Instructions:</h2>
                        <ul className=" pt-6 pl-12 pr-12 space-y-1 list-disc list-outside font-serif">
                            <li className="list-item">The
                                <p className="inline font-bold text-yellow-400"> yellow box </p> 
                                in the image below is the main parking lot where you should park.
                        ...
                        <Image src="/hinkley_birdseye.png" alt="google maps birdseye view of hinkley high school" width={400} height={400} className="flex w-full pt-4 rounded-md"/>
                    </div>
                </div>
          ...
          <div className="flex flex-col w-full h-full p-4 md:ml-6 justify-center md:rounded-md">
            ...
            <ul className=" pt-6 pl-12 pr-12 space-y-1 list-disc list-outside font-serif">
              ...
              <li className="list-item">
                The
                <p className="inline font-bold text-yellow-400"> yellow box </p>
                in the image below is the main parking lot where you should
                park.
              </li>
              <li>
                Enter the school from the main entrance north of the parking lot
                and up the stairs, highlighted by the
                <p className="inline font-bold text-red-500"> red box</p>. There
                will be two signs next to the entrance that say "pool entrance"
                and "athletic entrance".
              </li>
              <li>
                Follow the sign leading towards the "athletic entrance". also
                known as door 2.
              </li>
              <li>
                The pool doors will be on your left as you walk down the
                hallway.
              </li>
              <li>Enjoy your swim!</li>
            </ul>
            <Image
              src="/rangeview_birdseye.png"
              alt="google maps birdseye view of rangeview high school"
              width={400}
              height={400}
              className="flex w-full pt-4 rounded-md"
            />
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:w-1/3">
          <div className="flex flex-col w-full h-full p-4 md:mr-6 justify-center md:rounded-md">
            ...
            <ul className=" pt-6 pl-12 pr-12 space-y-1 list-disc list-outside font-serif">
              ...
              <li>
                Enter the school from the main entrance south of the parking
                lot, highlighted by the
                <p className="inline font-bold text-red-500"> red box </p>.
              </li>
              <li>
                Take an immediate right once you enter into the school, and head
                through the doors into the hallway leading to the pool.
              </li>
              <li>
                The pool doors will be on your left as you walk down the
                hallway.
            ...
            <Image
              src="/gateway_birdseye.png"
              alt="google maps birdseye view of gateway high school"
              width={400}
              height={400}
              className="flex w-full pt-4 rounded-md"
            />
